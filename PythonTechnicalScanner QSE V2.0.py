...
def main() :
    ...
    min_volume = 5000  # Filter by this volume threshold
    ...
    while True :
        ...
        today_Strong_buy = recommended_symbols [
            recommended_symbols [ 'Date and Time' ] == datetime.datetime.now ( ).date()] # Assuming the date is in the first column 
        today_buy= buy_symbols [
            buy_symbols['Date and Time'] == datetime.datetime.now().date()] # Assuming the date is in the first column
