...
def is_trading_hours():
    ...
    trading_start_time = datetime.strptime('07:00:00', '%H:%M:%S').time()
    trading_end_time = datetime.strptime('07:30:00', '%H:%M:%S').time()
    ...
    try:
        if is_trading_hours():
            ...
            if analysis_data:
                ...
                report_df = report_df.to_string( index=True, justify='left', col_space=10)
