...
def get_symbol_selection():
    df = pd.read_excel('psxsymbols.xlsx', sheet_name='NIFTY200')
...
def is_trading_hours():
    ...
    trading_start_time = datetime.strptime('00:00:00', '%H:%M:%S').time()
...
def save_daily_report(data):
    ...
    filename = 'Nifty200-Daily_Analysis_Report.xlsx'
    try:
    ...
    try:
        if is_trading_hours():
            ...
            for symbol in symbol_selection:
                ...
                for time_frame in all_time_frames:
                    try:
                        ...
                        if summary == 'STRONG_BUY' and ao > 0:  
                            strong_buy_count += 1
                        elif summary == 'STRONG_SELL' and ao < 0:
                            strong_sell_count += 1
            ...
            if analysis_data:
                ...
                attachment_path = 'Nifty200-Daily_Analysis_Report.xlsx'
                subject = f"Nifty200-Daily Report - {datetime.now().strftime('%Y-%m-%d')}"
