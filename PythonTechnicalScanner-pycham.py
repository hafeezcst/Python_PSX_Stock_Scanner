...
def analyze_symbol(symbol, analysis_type, base_url_charts,base_url_finan,base_url_tech):
    try:
        ...
        if 'analysis' in locals() and 'analysis' in globals() and analysis is not None and analysis.get_analysis() is not None:
            ...
            if summary is not None: 
                ...
                return symbol, summary, Buy_Signal,Sell_Signal,Neutral_Signal,Close, Volume, RSI, RSI_Last, AO, Change, Charts, Financials, Technicals
