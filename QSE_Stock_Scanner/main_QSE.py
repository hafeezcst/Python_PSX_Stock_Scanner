...
def main():
    ...
    with ThreadPoolExecutor ( max_workers=500 ) as executor :  # Adjust max_workers as needed
        ...
        symbol_selection = input (
            f"Select symbol List ({', '.join ( symbol_options )}), press Enter for default List QSE: " ).upper ( )
        ...
        BASE_URL_CHARTS = "https://www.tradingview.com/chart/ZMYE714n/?symbol=QSE%3A"
        BASE_URL_FINANCE = "https://www.tradingview.com/symbols/QSE-"
        BASE_URL_TECH = "https://www.tradingview.com/symbols/QSE-"
